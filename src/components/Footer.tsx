      ...
      <div className="bg-sky-deep wave-pattern">
        <div className="container mx-auto px-4 py-14">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div>
              ...
              <p className="text-white/70 font-body text-sm leading-relaxed max-w-xs">
                Coastal-inspired phone cases, designed with intention. Small batch, crafted with care on the California coast.
              </p>
            ...
            <div>
              ...
              <div className="flex flex-col gap-2.5 text-sm text-white/70 font-body">
                <a href="#" className="flex items-center gap-2 hover:text-white transition-colors">
                  <Instagram className="h-4 w-4" /> @maximal
                </a>
                <a href="#" className="flex items-center gap-2 hover:text-white transition-colors">
                  <Mail className="h-4 w-4" /> hello@maximal.com
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 pt-6 border-t border-white/15 text-center text-xs text-white/50 font-body">
            &copy; {new Date().getFullYear()} MAXIMAL. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
